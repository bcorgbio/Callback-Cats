...
Phylogenetic ridge regression was used to detrmine  whether major groups of the Lepidoptera have undergone significant changes in the rate of wing-shape evolution. 
...
```{r, "Load tree, drop tips not in PCA data", results = FALSE, message = FALSE}
