...
#### The fourth order model fits the best to data because is has the lowest AIC score. 
...
#### The thirds order model fits to the data the best because is has the lowest AIC score. 
