...
PC scores were first used to analyze the evolutionary rate for the hind and forewing. Species information was also added to the PCA data.
...
We  then examined the evolutionary rates of the PC scores across a Lepidopteran  phylogentic tree from the @kawahara2019phylogenomics study.
...
Phylogenetic ridge regression was used to determine  whether major groups of the Lepidoptera have undergone significant changes in the rate of wing-shape evolution. 
...
Phylogenetic independent contrasts (PIC) analysis was used to determine whether hind- and forewing shape evolution is correlated.
...
<div class="comment">
We need tags for thes refs to be included. This is pretty close to a cut and paste of the project description.
...
Matteo Torquati: wrote the Methods to the report
Julie Vu: wrote the Introduction to the report.

<div class="comment">
Excellent work. Thanks for staying the course and producings a very fine analysis more relective of graduate work. Congrats to you all!
